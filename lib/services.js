...
function loadFileAsAttachment(worker, link) {
  if (link != null) {
    var request = Request({
      url: api_url + "/attachments/link/" + JSON.parse(link).taskId,
      headers: {
        "Accept": "application/json",
        "Content-Type": "application/json",
        "pragma": "no-cache"
...
function getLogEntries(worker, param) {
  var request = Request({
    url: api_url + "/log/latest/",
    headers: {
      "Accept": "application/json",
      "Content-Type": "application/json",
      "pragma": "no-cache"
    ...
    onComplete: function (response) {
      if (response.status != 200) {
        ...
        worker.port.emit("LatestLogEntriesLoaded", response.json);
      }
    }
  }).post();
...
function getAllQueriesFromLog(worker, taskId) {
  var request = Request({
    url: api_url + "/log/queries/" + taskId,
    headers: {
      "Accept": "application/json",
      "Content-Type": "application/json",
      "pragma": "no-cache"
...
function getLatestQueriesFromLog(worker, logQuery) {
  var request = Request({
    url: api_url + "/log/queries/latest",
    headers: {
      "Accept": "application/json",
      "Content-Type": "application/json",
      "pragma": "no-cache"
