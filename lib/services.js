 ...
 */
function getAllLogEntries(worker, userId) {
...
/**
 * Delete all log entries that store the browsing history of a task.
 */
function removeBrowsingHistory(worker, taskId) {
  if (taskId != null) {
...
} exports.removeBrowsingHistory = removeBrowsingHistory;
